...
from models.backbone_pointcloud.pointnet2_lib.pointnet2.pointnet2_modules import PointnetFPModule, PointnetSAModuleMSG
from .p_config import cfg

from ..registry import POINTCLOUD_BACKBONES
...
@POINTCLOUD_BACKBONES.register_module
class Pointnet2MSG(nn.Module):
    def __init__(self, input_channels=1, use_xyz=True):
    ...
    def forward(self, pointcloud: torch.cuda.FloatTensor):
        ...
        final_feature = torch.squeeze(torch.max(l_features[-1], 1), 1)
